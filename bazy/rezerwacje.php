		...
		<div class="content">
            ...
            <?php
			   ...
			   $dbname = "kamild160_projekt";
				...
				or nrrezerwacja like '%".$rezerwacja."%';";
			
				//$sql2 = "SELECT * from gosc where telefon ='%".$tel."%';";
				//$sql3 = "SELECT * from gosc join rezerwacja where nrrezerwacja ='%".$rezerwacja."%';";
				...
				echo $row["imie"]. " " . $row["nazwisko"]."  -  Nr.rezerwacji: ". $row["nrrezerwacja"]."<br>";
